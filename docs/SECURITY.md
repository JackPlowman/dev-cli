...
1. Go to the [Security tab](https://github.com/JackPlowman/dev-cli/security) of the repository.
...
We will notify users about security updates through the repository's release notes and the [Security Advisories](https://github.com/JackPlowman/dev-cli/security/advisories) section.
